...
**Seed data** is loaded via migration `0002_seed_inventory.py` (idempotent). The risk formula is inlined there deliberately to avoid migration fragility if the service signature changes.
