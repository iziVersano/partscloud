"""
Re-import / refresh SKU data from a CSV export.

Unlike the seed migration (which only ever runs once against a fresh DB),
this command can be re-run any time a new ERP export needs to be loaded.
Bad rows are skipped and reported rather than aborting the whole import.

Usage:
    python manage.py import_skus path/to/export.csv
"""
import csv
